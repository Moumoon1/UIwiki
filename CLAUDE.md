...
Before performing any design, creation, update, or writing tasks in Figma (or when using `m0_figma` or `use_figma` tools), you MUST strictly adhere to the following startup workflow:

1. **Forced Rule and Skill Reading**: 
   You MUST always read and load the full text of `.m0/rules/force-uibuilder.md` and `.m0/skills/uibuilder/SKILL.md` BEFORE formulating any plan, code, or running any writes.
